...
const initialCardData: CardData = {
  ...
  backgroundImageUrl: 'https://raw.githubusercontent.com/UmEsH-HaSaRaNgA/Birthday-card-generator-tool/main/public/my-background.jpg', // Updated Default background
  decorations: {
    showBalloons: true,
    showCake: true,
    showStars: true,
